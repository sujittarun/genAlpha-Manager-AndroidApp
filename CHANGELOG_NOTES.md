...
- If parent replies `Paid` or sends an image/document screenshot on WhatsApp, the function marks the payment flow as `payment_pending_verification` and replies: `Once the academy confirms the payment, we’ll update your renewal and send the receipt.`
