...
class SupabaseRepository(
    ...
    suspend fun submitAdmission(draft: AdmissionDraft): AdmissionInsertResult = withContext(Dispatchers.IO) {
        ...
        val body = JSONObject()
            ...
            .put("p_fee_plan", draft.feePlan.ifBlank { "pending" })
        ...
        try {
            ...
            try {
                ...
                val insertBody = JSONObject()
                    ...
                    .put("fee_plan", draft.feePlan.ifBlank { "pending" })
    ...
    suspend fun recordJerseyPairAdjustment(
        ...
        return withContext(Dispatchers.IO) {
            ...
            val chargeableDelta = safeNextPairs - previousPairs
